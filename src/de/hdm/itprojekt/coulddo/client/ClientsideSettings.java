...
import de.hdm.itprojekt.coulddo.shared.CommonSettings;
...
public class ClientsideSettings extends CommonSettings {
	 ...
	 */
	private static CouldDoServiceAsync editorVerwaltung = null;
	 ...
	 * 
	 * // Gab es bislang noch keine Verwaltung-Instanz, wird eine erstellt. if
	 * (loginService == null) {
	 * 
	 * // Instantiieren des EditorService's. loginService =
	 * GWT.create(LoginService.class); }
	 * 
	 * // Rueckgabe des EditorService's. return loginService; }
	 */
	 ...
	 * erstellt. // Auch ein sogenannter <Singleton> if (reportGeneratorVerwaltung
	 * == null) {
	 * 
	 * reportGeneratorVerwaltung = GWT.create(ReportGenerator.class); final
	 * AsyncCallback<Void> initReportGeneratorServiceCallback = new
	 * AsyncCallback<Void>() {
	 * 
	 ...
	 * ClientsideSettings.getLogger().
	 * info("Der ReportGenerator wurde initialisiert."); } };
	 * 
	 * reportGeneratorVerwaltung.init(initReportGeneratorServiceCallback); }
	 * 
	 * // Rueckgabe des ReportGeneratorService's. return reportGeneratorVerwaltung;
	 * }
	 */
